...
//    public final static int[] supportDevices = {300, 310, 320, 330, 340, 350, 360, 370, 380, 390, 400, 411, 420, 432, 440, 450, 460, 470, 480, 490, 500, 520, 553, 570, 600, 620}; //TODO 自用
    public final static int[] supportDevices = {300, 320, 340, 360, 370, 384, 392, 400, 411, 420, 450, 480, 520, 533, 600, 620};
//    public final static int[] supportDevices = {360, 392, 533};

    public final static String path = "D:\\cloud\\SWScreenUtil\\app\\src\\dimens";                 //相对文件地址
//    public final static String path = "C:\\Users\\Utopia\\Desktop\\"; //绝对地址
